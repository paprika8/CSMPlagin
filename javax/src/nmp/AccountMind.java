...
public class AccountMind {
    Player player;
    public static final String[] prefixes = new String[]{"[green][U][]", "[cyan][Mл M][]", "[sky][M][]", "[blue][Cт M][]", "[red][A][]", "[SCARLET][Ст A][]", "[BRICK][Кур A][]", "[TAN][ЗГА][]", "[GOLDENROD][ОЗГА][]", "[GOLD][ГA][]", "[ORANGE][зСA][]", "[MAROON][СA][]", "[OLIVE][КП][]", "[red][Т/А][]", "[red][Ст Т/А][]", "[SCARLET][Кур Т/А][]", "[SCARLET][ГКур Т/А][]", "[BRICK][зГ Т/С][]", "[CRIMSON][Г Т/С][]", "[red][Ютубер][]"};
